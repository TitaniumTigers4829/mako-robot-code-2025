...
//     // PoseEstimate
//     assertEquals(new PoseEstimate(),
// physicalVision.getMegaTag1PoseEstimate(Limelight.FRONT_LEFT));
...
//     assertEquals(new PoseEstimate(),
// physicalVision.getMegaTag2PoseEstimate(Limelight.FRONT_LEFT));
...
//     // assertEquals(expectedPoseEstimate.pose(),
//     // physicalVision.getPoseFromAprilTags(Limelight.BACK));
//     // assertEquals(
